...
const Footer = () => {
  return (
    <div className="bg-[#111]">
      <div className="px-4 py-10 footer relative container">
        ...
        <div className="mt-5 text-xs text-gray-500">
          Next Anime does not store any files on our server, we only linked to
          the media which is hosted on 3rd party services.4
          <br />
